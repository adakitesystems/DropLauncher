...
public class View extends JFrame {
  ...
  public View() {
    ...
    /* Init components via the autogenerated code. */
    initComponents();
    ...
    /* Listeners. */
    CloseViewListener closeViewListener = new CloseViewListener(this);
    addWindowListener(closeViewListener);
  ...
  /**
   * Displays and modifies the specified file dialog object.
   *
   * @param fc the specified file dialog object
   * @return
   *     the response after the file dialog object has been closed
   */
   ...
   *
   * @param messageType specified message type, e.g. JOptionPane
   * @param str specified message to display
   */
  ...
  /**
   * Updates the UI components by displaying the values of model variables.
   */
  public void update() {
    /* StarCraft.exe */
  ...
  /**
   * Sets the specified component's display text.
   *
   * @param component specified component
   * @param str specified text to display
   */
  ...
  /**
   * Removes all selections from the race button group.
   */
